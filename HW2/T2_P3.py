...
visualize_boundary(lr, X, y, 'logistic_regression_result_final')
...
X_test = np.array([[6, 2]])
y_nb1 = nb1.predict(X_test, get_probs=True)
y_nb2 = nb2.predict(X_test, get_probs=True)
y_lr = lr.predict(X_test, get_probs=True)
